...
import { ShieldCheck, Users2, BrainCircuit, Rocket, ChevronRight } from 'lucide-react';
  ...
  return (
    <section className="py-48 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-end justify-between mb-32 space-y-10 lg:space-y-0">
          ...
          <div className="max-w-sm">
            <p className="text-gray-400 text-lg font-light leading-relaxed">
              Metode pendidikan kami dirancang untuk mengimbangi kecepatan inovasi global tanpa meninggalkan kearifan lokal.
            </p>
          </div>
        </div>
